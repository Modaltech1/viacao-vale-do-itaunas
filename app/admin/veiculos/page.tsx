...
import { BadgeAlert, Bus, CircleCheckBig, Plus, Wrench } from 'lucide-react'
...
export default function VehiclesPage() {
  ...
  const loadVehicles = useCallback(async () => {
    ...
    try {
      const response = await fetch('/api/admin/veiculos', { cache: 'no-store' })
  ...
  return (
    <>
      <PageHeader
        title="Veículos"
        description="Cadastro dos ativos, vínculos com motoristas, rota fixa, documentos e situação operacional."
      >
      ...
      <Card>
        <CardContent className="space-y-4 p-4">
          <div className="grid gap-3 lg:grid-cols-[minmax(240px,1fr)_minmax(180px,0.5fr)_minmax(180px,0.5fr)_minmax(220px,0.65fr)]">
            <FilterInput
